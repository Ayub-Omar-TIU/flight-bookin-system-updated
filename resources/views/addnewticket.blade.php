    ...
    <div class="container">
        <div class="row justify-content-center">
            @if (!is_null(Auth::user()->userType) && Auth::user()->userType == 'admin')
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('Add New Ticket') }}</div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="takeoffAirport" type="text"
                                            ...
                                            name="takeoffAirport" value="{{ old('takeoffAirport') }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="takeoffDate" type="datetime-local"
                                            ...
                                            name="takeoffDate" value="{{ old('takeoffDate') }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="landingAirport" type="text"
                                            ...
                                            name="landingAirport" value="{{ old('landingAirport') }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="landingDate" type="datetime-local"
                                            ...
                                            name="landingDate" value="{{ old('landingDate') }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="stop" type="number" max="5"
                                            ...
                                            value="{{ old('stop') }}" required autocomplete="stop" autofocus>
